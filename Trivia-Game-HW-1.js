...
var questionsArray = [
    "Who has the most career points of all time?",
    "What player has the most NBA championships in the league?"
];
var answersArray = [
    ["Kareem Abdul-Jabbar", "Karl Malone", "Kobe Bryant", "Michael Jordan"],
    ["Robert Horry", "Bill Russell", "Michael Jordan", "Bob Cousy"]
];
var correctArray = [
